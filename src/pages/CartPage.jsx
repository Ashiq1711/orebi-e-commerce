...
const CartPage = () => {
  ...
  useEffect(()=>{
    async function getAllcart(){
      ...
      axios.get('http://localhost:3000/api/v1/cart/getcart').then((data)=>{
            ...
            <div class="bg-white h-max rounded-md p-6 shadow-[0_0px_4px_0px_rgba(6,81,237,0.2)] sticky top-0">
              ...
              <ul class="text-gray-800 text-sm divide-y mt-4">
                <li class="flex flex-wrap gap-4 py-3">
                  Subtotal <span class="ml-auto font-bold">$2120.00</span>
                </li>
                <li class="flex flex-wrap gap-4 py-3">
                ...
                <li class="flex flex-wrap gap-4 py-3 font-bold">
                  Total <span class="ml-auto">$2920.00</span>
                </li>
              </ul>

              <button
                type="button"
                class="mt-4 text-sm px-6 py-3 w-full bg-blue-600 hover:bg-blue-700 text-white rounded-md"
              >
                Make Payment
              </button>
            </div>
